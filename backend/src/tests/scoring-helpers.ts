...
export const combineCriteria = (
  criterium1: CriteriumScore,
  criterium2: CriteriumScore,
) => {
...
export const extractCriteria = (criterium: Criterium): CriteriumScore => {
...
export const calculateScorePercentage = (score: AggregatedScore): number => {
...
export const combineScore = (scores: AggregatedScore[]): AggregatedScore => {
...
export const choiceToScore = (choice: string): AggregatedScore => {
